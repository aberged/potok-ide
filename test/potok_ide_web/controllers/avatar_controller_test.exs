defmodule PotokIdeWeb.AvatarControllerTest do
  ...
  describe "GET /avatar/profile/:id" do
    ...
    test "decodes base64 image data and returns it", %{conn: conn, profile: profile} do
      ...
      png_bytes = <<137, 80, 78, 71, 13, 10, 26, 10, 0, 0, 0, 13, 73, 72, 68, 82, 0, 0, 0, 1,
        0, 0, 0, 1, 8, 6, 0, 0, 0, 31, 21, 196, 137, 0, 0, 0, 10, 73, 68, 65, 84, 8, 29, 1,
        0, 0, 255, 255, 0, 1, 0, 1, 16, 32, 148, 144, 0, 0, 0, 0, 73, 69, 78, 68, 174, 66,
        96, 130>>
    ...
    test "caches avatar for 24 hours", %{conn: conn, profile: profile} do
      ...
      jpeg_bytes = <<255, 216, 255, 224, 0, 16, 74, 70, 73, 70, 0, 1, 1, 0, 0, 1, 0, 1, 0, 0,
        255, 219, 0, 67, 0, 8, 6, 6, 7, 6, 5, 8, 7, 7, 7, 9, 9, 8, 10, 12, 20, 13, 12, 11,
        11, 12, 25, 18, 19, 15, 20, 29, 26, 31, 30, 29, 26, 28, 28, 30, 31, 32, 32, 32, 32,
        32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
        32, 32, 32, 32, 32, 32, 255, 217>>
    ...
    test "detects mime type from data URL", %{conn: conn, profile: profile} do
      ...
      gif_bytes = <<71, 73, 70, 56, 57, 97, 1, 0, 1, 0, 128, 0, 0, 255, 255, 255, 0, 0, 0,
        33, 249, 4, 1, 0, 0, 0, 0, 44, 0, 0, 0, 0, 1, 0, 1, 0, 0, 2, 1, 68, 0, 59>>
